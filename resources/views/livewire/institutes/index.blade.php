        ...
        <table class="text-xs sm:text-sm text-center mx-auto sm:w-[990px] w-[800px]">
            ...
            @foreach($institutes as $institute)
                <tr class="h-12 dark:text-zinc-300">
                    <td class="border dark:border-zinc-600">{{$institute->id}}</td>
                    <td class="border dark:border-zinc-600">{{$institute->short_name}}</td>
                    <td class="border dark:border-zinc-600">{{$institute->full_name}}</td>
                    <td class="border dark:border-zinc-600">{{$institute->abb}}</td>
                    <td class="border dark:border-zinc-600">{{$institute->remain_credit}}</td>
                    <td class="border dark:border-zinc-600">{{$institute->logo_url}}</td>
                    <td class="border dark:border-zinc-600">
                        {{substr($institute['created'], 0, 10)}}
                        <hr class="dark:border-slate-600">
                        {{substr($institute['created'], 11, 5)}}
                    </td>
                    <td class="border dark:border-zinc-600">{{$institute->updated}}</td>
                    <td class="border dark:border-zinc-600">
